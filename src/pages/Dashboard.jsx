...
import app from "../utils/firebase"; // Ensure this points to your Firebase configuration
...
export default function Dashboard() {
  ...
  const [totalProfit, setTotalProfit] = useState(45200); // Example static value for total profit
  const [totalProfitRate, setTotalProfitRate] = useState(4.35); // Example static rate
