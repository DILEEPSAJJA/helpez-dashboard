  ...
  return (
    <>
      {!loading && incidents && categoryCounts && (
        <>
          <div className="mt-4 sm:px-7.5 col-span-12 rounded-lg border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-5">
