  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      {dropdownOpen && (
        ...
        >
          <ul className="flex flex-col gap-5 px-6 py-4 dark:border-strokedark">
            <li>
              <Link
                to="https://github.com/suraj719/helpEZ"
                target="_blank"
                className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-blue-400 lg:text-base"
              >
                <svg
